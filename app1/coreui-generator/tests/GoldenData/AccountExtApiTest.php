...
class AccountExtApiTest extends TestCase
{
    ...
    public function create_transaction($account, $shares, $value, $currentValue, $matching, $date)
    {
        $transaction = array();
    ...
    public function _test_account_transactions_as_of($id, $asOf, $transactions, $currentValues)
    {
        ...
        foreach ($transactions as $transaction) {
            [$shares, $value, $matching, $date] = $transaction;
            $currentValue = $currentValues[$i++];
            $arr['transactions'][] = $this->create_transaction($id, $shares, $value, $currentValue, $matching, $date);
        }
        // var_dump($arr);
    ...
    {
        return [2068.07, 2293.14, 3174.06, 3456.18];
    }
    ...
    public function test_account_balance_as_of()
    {
        ...
        $this->_test_account_balance_as_of(7, '2021-07-01', 2264.61, $balance[1]);
        $this->_test_account_balance_as_of(7, '2022-01-01', 2264.61, $balance[2]);
        $this->_test_account_balance_as_of(7, '2022-01-15', 2561.0072, $balance[3]);
    }
    ...
    public function test_account_transactions_as_of()
    {
        ...
        $t1 = [2000, 2000, null, '2021-01-01' . $time];
        $t2 = [132.305, 150, null, '2021-07-01' . $time];
        $t3 = [132.305, 150, 1, '2021-07-01' . $time];
        $time = 'T02:35:00.000000Z';
        $t4 = [37.0496, 50, null, '2022-01-09' . $time];
        $t5 = [111.1489, 150, null, '2022-01-09' . $time];
        $t6 = [37.0496, 50, 1, '2022-01-09' . $time];
        $t7 = [111.1489, 150, 4, '2022-01-09' . $time];
